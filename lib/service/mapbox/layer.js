  ...
  return function (self, options) {
    ...
    function update(layer) {
      if (self._m && added) {
        if (layer) {
          ...
          if (self._under) {
            updateProperties(self._m, self._under, 'paint', 'setPaintProperty');
            updateProperties(self._m, self._under, 'layout', 'setLayoutProperty');
          }
          return;
        }
    ...
    function option(key, value) {
      ...
      if (key === 'visible') {
        ...
        if (self._under) {
          self._under.layout.visibility = value ? 'visible' : 'none';
        }
        if (self._m && added) {
          self._m.setLayoutProperty(self._l.id, 'visibility', self._l.layout.visibility);
          if (self._under) {
            self._m.setLayoutProperty(self._under.id, 'visibility', self._under.layout.visibility);
          }
        }
      }
